...
import { ArrowLeft, Briefcase, ChevronLeft, ChevronRight, Eye, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, Sparkles, User } from 'lucide-react';
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        hover:text-slate-700 transition-all">
          <ArrowLeft className="size-4"/> Back To Dasboard
        </Link>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
            ...
            {/*Resume Options */}
              ...
              <div className="flex items-center">
                {activeSectionIndex !== 0 && (
                  <button onClick={() => setActiveSectionIndex((prevIndex) => Math.max(prevIndex-1, 0))} className="flex 
            ...
            text-green-600 ring hover:ring-green-400 transition-all rounded-md
        ...
        <div className="lg:col-span-7 max-lg:mt-6">
          <div className="relative w-full">
              ...
              justify-end gap-2">
                {resumeData.public && (
                  <button className="flex items-center p-2 px-4 gap-2 text-xs bg-linear-to-br
                ...
                <button>
                  {resumeData.public ? <Eye className="size-4"/>: <EyeOffIcon className="size-4"/>}
                </button>
              </div>
          </div>
