...
const Testimonials = () => {
    ...
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
        ...
        <p className="text-sm py-4 text-gray-800">Resume Builder made finding my dream job an absolute
            breeze.</p>
  ...
  return (
    <>
    <div id="testimonials" className="flex flex-col items-center my10 scroll-mt-12">
        ...
        <Title title="Don't just take out words" description="Hear what our users say about us.
